...
execute as @a[scores={lasertagLives=..0}] at @s run tp @s @e[tag=lasertagEndpoint, distance=..50, limit=1, sort=nearest]
execute as @a[scores={lasertagLives=..0}] at @s run scoreboard players reset @s lasertagLives
